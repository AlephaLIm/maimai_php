...
class ProfileController extends Controller
{
    public static function profile($id)
    {
        ...
        $data = DB :: select('SELECT charts.level, scores.score, scores.scoregrade, scores.combograde from scores inner join charts on scores.chartid=charts.chartid AND scores.friendcode = ? AND scores.scoregrade LIKE "S%";',[$id]);
        $uniqueLevels = array();
        $levelArray = array();
